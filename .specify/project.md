...
- **All 37 .specify/ feature specs** complete and verified against code (`ls .specify/features/*.md | wc -l` = 37 — full per-spec catalogue under "Spec Kit (.specify/)" in `docs/index.md`). The 37 = 28-pre-saga-baseline + 3 saga-additions + 3 audit-tooling additions + 1 multi-option umbrella (iter 218) + 1 user-directed config-path migration (2026-05-09) + 1 user-directed LLM/AI discoverability pass (2026-05-09, iter 221): `q22-mobilemenu-ct.md` (iteration 108), `q27-mobilemenu-empty-items-coverage.md` (iteration 123, ✅ RESOLVED in iteration 124), `q28-eslint-10-upgrade.md` (iteration 129, **✅ RESOLVED in iteration 130**), `audit-docs-script.md` (iteration 149, **✅ RESOLVED in iteration 149**), `audit-docs-self-parity.md` (iteration 151, **✅ RESOLVED in iteration 151**), `audit-docs-matrix-prose.md` (iteration 161, **✅ RESOLVED in iteration 161**), `multi-option-support.md` (iteration 218, **OPEN — Phase 6 of 8 ✅ DELIVERED iter 219, 7 phases queued**), and `works-config-path.md` (2026-05-09, **✅ RESOLVED** — canonical site config path is `.works/works.yml`). Q23 / Q25 / Q26 do not have dedicated spec files — those questions were resolved inline in `docs/questions.md` (Q23 + Q25 absorbed into Q22 follow-up arcs; Q26 absorbed into the Q22-follow-up-#3 spec at `q22-playwright-coverage.md`). The Q22→Q28 saga remains fully closed; every Q22-arc question (Q22, Q23, Q24, Q25, Q26, Q27, Q28) reports ✅ RESOLVED in `docs/questions.md`, and the merged `pnpm coverage` pipeline writes a per-package report at branches **100% (233/233)**.
