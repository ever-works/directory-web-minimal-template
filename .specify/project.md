...
- **458 unit tests** (Vitest) across 28 test files — all passing
- **569 E2E tests** (Playwright) across 46 spec files, 5 sample projects — all passing (27 skipped: mobile-only/sitemap)
