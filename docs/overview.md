...
- **Static-first**: Astro 6 with static output, optional ISR via `@astrojs/vercel`
...
- **Headless components**: 25 Astro + 8 Preact unstyled building blocks + 22 primitive components
