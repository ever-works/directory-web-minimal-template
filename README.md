...
apps/
  ...
  web-e2e/            Playwright E2E tests (364 test cases, 56 spec files, 11 projects incl. mobile + visual regression)
...
| `pnpm test:e2e` | Run E2E tests — 364 tests, 56 specs, 11 projects (Playwright) |
